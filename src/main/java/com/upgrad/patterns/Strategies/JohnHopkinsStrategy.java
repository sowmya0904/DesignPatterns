...
public class JohnHopkinsStrategy implements IndianDiseaseStat {
    ...
    public String GetActiveCount() {
        ...
        return String.valueOf(Math.round(confirmed));
    }
    ...
    private JohnHopkinResponse[] getJohnHopkinResponses() {
        ...
        return restTemplate.exchange(baseUrl, HttpMethod.GET, new HttpEntity<Object>(headers), JohnHopkinResponse[].class).getBody();
    }
}
